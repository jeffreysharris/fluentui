...
export interface IToggleBasicExampleProps {
  id?: string;
}

export const ToggleBasicExample: React.FunctionComponent<IToggleBasicExampleProps> = props => {
  const id = props.id;
  return (
    <Stack {...stackTokens} id={id}>
